...
<body>
	<aside class="visible col-lg-2">
		<br>
		<li class="title_sidebar">Proveedor</li>
		<br><br>
		<ul>
	...
	<div class="main col-lg-10">
		<form name="proveedor" method="post" action="datos_proveedor.php">
		<div class="rellenar" id="editorial" class="">
			...
			<div class="form-group">
				...
				<div class="col-lg-6"><input type="text" name="nombre_proveedor" id="cedula" class="form-control"/></div><br>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">Contacto</label>
				<div class="col-lg-6"><input type="text" name="contacto_proveedor" id="nombre_usuario" class="form-control"/></div><br>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">Email</label>
				<div class="col-lg-6"><input class="form-control" type="text" name="email_proveedor" id="apellido_usuario"/></div><br>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">Telefono</label>
				<div class="col-lg-6"><input class="form-control" type="number" name="telefono_proveedor" id="clave"/>
				</div><br>
			</div>
			<div class="form-group">	
				<label class="col-lg-3 control-label">Direccion</label>
				<div class="col-lg-6"><input class="form-control" type="text" name="direccion_proveedor" id="tipo"/>
				</div><br>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">Ciudad</label>
				<div class="col-lg-6"><input class="form-control" type="text" name="ciudad_editorial" id="nombreu"/>
				</div><br>
			</div>
