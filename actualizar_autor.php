		...
		<form name='form' enctype="multipart/form-data" method='post' action='datos_actualizar_autor.php?var=<?php echo $id_autor?>'>
			...
			<div class="rellenar2">
				...
				<div class="btn-group col-lg-offset-6">
						<button type="" value="guardar" class="btn btn-md btn-final">
						<!-- onclick="JavaScript:windows:print()"> -->
						<?php echo "<a href='formato_impresion_autor.php?var=".$id_autor."'>Imprimir Reseña</a></button>";?>
