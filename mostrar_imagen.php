...
if (is_uploaded_file(@$_FILES["userfile"]["tmp_name"]))
{
    ...
    if ($_FILES["userfile"]["type"]=="image/jpeg" || $_FILES["userfile"]["type"]=="image/pjpeg" || $_FILES["userfile"]["type"]=="image/gif" || $_FILES["userfile"]["type"]=="image/bmp" || $_FILES["userfile"]["type"]=="image/png")
    {
        ...
        $sql="INSERT INTO `cambio_imagen` (anchura,altura,tipo,imagen) VALUES (".$info[0].",".$info[1].",'".$_FILES["userfile"]["type"]."','".$imagenEscapes."')";
...
<div class="listadoImagenes">
    <?php
    $result=mysql_query("SELECT * FROM cambio_imagen ORDER BY id DESC",$link);
    if($result)
    {
