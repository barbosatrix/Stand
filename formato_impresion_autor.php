...
<button type="" value="guardar" class="btn btn-md btn-final" onclick="JavaScript:windows:print()">Imprimir Reseña</a></button>
<button type="" value="enviar" class="btn btn-md btn-final"><a href="mailto:someone@example.com?Subject=Hello%20again" target="_top">Enviar Mail</a></button>
</body>
</html>
