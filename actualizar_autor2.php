...
<body>
	...
	<div class="main  col-lg-10">
		<form name="form" method="post" action="datos_autor.php" class="">
			<div class="form-group rellenar">
				<div class="col-lg-8">
					...
					<div class="form-group">
						...
						value=<?php echo $autor['ano_autor']?> ></input></div>
				...
				<div class="form-group col-lg-4">
					<div class="col-lg-offset-3 foto">
						...
						<td><?php  echo"<img src='imagen_mostrar.php?id=".$autor["imagen"]."' width='320' height='310'>";
							       // echo "<img src='imagen_mostrar.php?id=".$row["id"]."' width='".$row["anchura"]."' height='".$row["altura"]."'>";
							?></td>
						</table>
					</div>
					<div class="form-group">
						<div class="col-lg-3"><input type="file" name="userfile" class="btn btn-lg"></div>
					</div><br>
					<div class="form-group">
			...
			<div class="rellenar2">
				<div class="form-group">
					...
					<div class="col-lg-10"><textarea name="reseña_autor" class="form-control" rows="10" placeholder="Escribe una pequeña reseña del autor"><?php echo $autor['reseña_autor']?></textarea></div>
				</div>
				<div class="btn-group col-lg-offset-9 btn-group-md">
