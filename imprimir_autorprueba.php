			...
			<div class="form-group rellenar">
				<div class="col-lg-8">
					<div class="form-group">	
						...
						value=<?php echo $autor['nombre_autor']?> ></input></div><br>
					</div>
					<div class="form-group">	
						...
						value=<?php echo $autor['apellido_autor']?> ></input></div><br>
					</div>
					<div class="form-group">
						...
						value=<?php echo $autor['seudonimo_autor']?> ></input></div><br>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						value=<?php echo $autor['web_autor']?> ></input></div><br>
					</div>
					<div class="form-group">
						...
						value=<?php echo $autor['email_autor']?> ></input></div><br>
					</div>
					<div class="form-group">
						...
						value=<?php echo $autor['direccion_autor']?> ></input></div><br>
					</div>
					<div class="form-group">
						...
						value=<?php echo $autor['ciudad_autor']?> ></input></div><br>
					</div>
					<div class="form-group">
